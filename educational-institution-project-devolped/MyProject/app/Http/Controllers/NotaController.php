...
class NotaController extends Controller
{
    ...
    public function updateDatosAlumno($dni_al, Request $request)
    {
        //
        /*$identificador = $dni_al;
        echo $identificador;

        echo $request->seccion;
        return print_r($request->grado_alumno);*/
        $id = $dni_al;
        $grado = trim($request->get('grado_alumno'));
        $seccion = trim($request->get('seccion'));
        //$user = Alumno::where('dni_al',$dni_al)->first();
        Alumno::where('dni_al', $dni_al)->update(['grado_alumno' => $grado, 'seccion_alumno' => $seccion]);
